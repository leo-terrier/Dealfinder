...
export const DealsContainerSm = ({ addDeal, savedDeals, removeDeal, deals, setDealOnMap }) => {
          ...
          return (
            <Grid item xs={12} sm={6} key={deal.deal_id}>
              <Paper sx={paper}>
                <Grid container spacing={2}>
                  <Grid item xs={12}>
                    <Typography component="p" variant="body1" sx={typography}>
                      {deal.streetNumber + " " + capitalizeFirstLetter(deal.streetName)}
                    </Typography>
                  ...
                  <Grid item xs={6}>
                    <Typography component="p" variant="body1" sx={typography}>
                      <strong>Rooms</strong> : {deal.nbOfRoom}
                    </Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Typography>{formatDate(deal.date)}</Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Button
                      onClick={(e) => {
