      ...
      {isLoadingResults ? (
        ...
        <Box sx={boxOut}>
          ...
          <Typography component="h2" sx={typography.b}>
            Search around this address <span style={{ fontWeight: "lighter" }}>(within 300 meters):</span>
          </Typography>
          <Box component="form" sx={boxIn}>
            <Grid container sx={grid}>
              <Grid item xs={12} md={6} sx={gridLabel}>
                <label htmlFor="address">
                  {" "}
                  Address <span style={{ fontWeight: "lighter" }}>(number and street):</span>
                </label>
              </Grid>
              <Grid item xs={12} md={6} sx={gridField}>
                <TextField
                  ...
                  placeholder="e.g., 33 quai de Bourbon"
                  required
                  fullWidth
                  sx={textField}
                />
              ...
              <Grid item xs={12} md={6} sx={gridLabel}>
                <label htmlFor="zipcode">
                  Zipcode <span style={{ fontWeight: "lighter" }}>(5 digits):</span>
                </label>
              </Grid>
              <Grid item xs={12} md={6} sx={gridField}>
                <TextField
              ...
              <Grid
                ...
                sx={{
                  ...gridWrongInput,
                  display: !wrongLocationInput && "none",
                }}
              >
                <Typography>Invalid address or zipcode</Typography>
              </Grid>
              <Grid
                item
                xs={12}
                sx={{
                  ...gridOptionalPhrase,
                  display: !isMoreFields ? "none" : "flex",
                }}
              >
              ...
              <Grid item xs={12} md={6} sx={{ ...gridField, display: !isMoreFields ? "none" : "flex" }}>
                <TextField
                  ...
                  value={specStreet}
                  onChange={(e) => {
                    setSpecStreet(e.target.value);
                  }}
                  fullWidth
                  required
                  placeholder="e.g., rue des Ecoliers"
                  sx={textField}
                />
              </Grid>
              <Grid item xs={12} sx={gridFab}>
                <Fab
                  ...
                  variant="fab"
                  onClick={() => {
                    setIsMoreFields((prev) => (prev ? false : true));
                  }}
                >
                  {isMoreFields ? <RemoveIcon /> : <AddIcon />}
                </Fab>
              </Grid>
              <Grid item xs={12}>
                <Button size="medium" sx={button} variant="addToSearch" onClick={handleSavingSearch}>
                  Add to favorites
                </Button>
              </Grid>
              <Grid item xs={12}>
            ...
            {savedSearches.length ? <SavedSearches savedSearches={savedSearches} removeSearch={removeSearch} clickSavedSearch={clickSavedSearch} /> : null}
          </Box>
        </Box>
      )}
    </Card>
